        ...
        @foreach($customers as $customer_element)
            <div class="table-row swipe-element">
                <div class="table-field-container swipe-front">
                    <div class="table-field"><p><span>Id CLIENTE:</span>{{$customer_element->id}}</p></div>
                    <div class="table-field"><p><span>Nombre:</span> {{$customer_element->name}}</p></div>
                    <div class="table-field"><p><span>Email:</span> {{$customer_element->email}}</p></div>
                    <div class="table-field"><p><span>Creado el:</span>{{$customer_element->created_at}}</p></div>
                </div>

                <div class="table-icons-container swipe-back">
                    <div class="table-icons edit-button right-swipe" data-url="{{route('customers_edit', ['customer' => $customer_element->id])}}">
                        <svg viewBox="0 0 24 24">
                            <path d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z" />
                        </svg>
                    </div>

                    <div class="table-icons delete-button left-swipe" data-url="{{route('customers_destroy', ['customer' => $customer_element->id])}}">
                        <svg viewBox="0 0 24 24">
    ...
    @if(isset($customer))
        <div class="tabs-container">
            ...
            <div class="icons">
                ...
                <div class="create-button" data-url="{{route('customers_create')}}">
                    <svg viewBox="0 0 24 24">
        ...
        <div class="content">
            ...
            <div class="content-item active" data-content="contenido">
                ...
                <form class="form-contact admin-form" action="{{route('customers_store')}}" id="contact-form">
                    ...
                    <div class="desktop-dos-columnas">
                        ...
                        <div class="columna">
                            <div class="contact-form-element">
                                ...
                                <div class="contact-form-input">
                                    <input type="text" name="lastname" value="{{isset($customer->lastname) ? $customer->lastname : ''}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="desktop-dos-columnas">
                        <div class="columna">
                            <div class="contact-form-element">
                                ...
                                <div class="contact-form-input">
                                    <input type="text" name="country" value="{{isset($customer->country) ? $customer->country : ''}}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="desktop-dos-columnas">
                        <div class="columna">
                            <div class="contact-form-element">
                                ...
                                <div class="contact-form-input">
                                    <input type="integer" name="cp" value="{{isset($customer->cp) ? $customer->cp : ''}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="columna">
                            <div class="contact-form-element">
                                ...
                                <div class="contact-form-input">
                                    <input type="integer" name="telephone" value="{{isset($customer->telephone) ? $customer->telephone : ''}}">
                                </div>
                            </div>
                        </div>
                    </div>
